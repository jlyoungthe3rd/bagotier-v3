...
| App State (`src/store/useAppStore.ts`)                                                                        | Root application audio control (`muted`, `toggleMute`, `setMuted`)                                               | Equipment domain business logic or catalog fetching               | `src/store/useAppStore.ts`                                                      |
